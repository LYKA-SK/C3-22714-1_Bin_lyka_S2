# Training Center Desk — Session 2 Starter (S3, S4)

A React + TailwindCSS frontend for the **Course Enrollment API** you know
...
You received the finished Course Enrollment API as a separate project:
...
| File                          | Tasks                  |
| ----------------------------- | ---------------------- |
| `src/pages/CoursesPage.jsx`   | S3.1, S4.1, S4.2       |
| `src/pages/EnrollPage.jsx`    | S3.2, S4.4             |
| `src/pages/StudentPage.jsx`   | S3.3, S4.3, S4.5       |
